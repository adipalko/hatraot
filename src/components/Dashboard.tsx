    ...
    <div dir="rtl" className="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <MetricCard
          ...
          value={selectedCities.length > 0 ? formatNumber(data.totalAlerts) : "—"}
          icon={Activity}
          accentClass="text-sky-400"
        />
        <MetricCard
          label={he.metricRockets}
          value={selectedCities.length > 0 ? formatNumber(rocketsCount) : "—"}
          icon={Rocket}
          accentClass="text-accent-red"
        />
        <MetricCard
          label={he.metricPeakHour}
          value={selectedCities.length > 0 ? data.peakHour : "—"}
          icon={Clock}
